...
<body class="bg-black text-[#e8e8e8]">
    ...
    <header class=' flex shadow-md py-4 px-4 sm:px-10 bg-black bg-opacity-50 font-sans min-h-[70px] tracking-wide relative z-50'>
        <div class='flex flex-wrap items-center justify-between gap-4 w-full'>
            <a href="javascript:void(0)"><img class="w-16" src="{{asset('assets/img/sushilogo.png')}}" alt="logo" class='w-36' />
