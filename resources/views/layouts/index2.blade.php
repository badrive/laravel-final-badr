    ...
    <header
        ...
        <div class='flex flex-wrap items-center justify-between gap-4 w-full'>
            ...
            <div id="collapseMenu"
                ...
                <ul
                    class='lg:flex gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-black max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
                    <li class='mb-6 hidden max-lg:block'>
                        <a href="javascript:void(0)"><img src="{{ asset('assets/img/sushilogo.png') }}" alt="logo"
                                class='w-36' />
                        </a>
                    </li>
